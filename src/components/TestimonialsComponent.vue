  ...
  <div class="dizme_tm_section">
    <div class="dizme_tm_testimonials">
        ...
        <div class="total">
              ...
              <swiper-slide>
                ...
                <div class="short">
                  <div class="image">
                    <div
                      class="main"
                      data-img-url="/public/img/testimonials/4.jpg"
                    ></div>
                  </div>
                  <div class="detail">
                    <h3>Mike Anderson</h3>
              ...
              <swiper-slide>
                ...
                <div class="short">
                  <div class="image">
                    <div
                      class="main"
                      data-img-url="/public/img/testimonials/3.jpg"
                    ></div>
                  </div>
                  <div class="detail">
                    <h3>Keita Smith</h3>
              ...
              <swiper-slide>
                ...
                <div class="short">
                  <div class="image">
                    <div
                      class="main"
                      data-img-url="/public/img/testimonials/6.jpg"
                    ></div>
                  </div>
                  <div class="detail">
                    <h3>Alan Walker</h3>
          ...
          <div class="left_details">
            <div
              ...
              data-img-url="/public/img/testimonials/2.jpg"
            ></div>
            <div
              class="det_image two wow fadeIn"
              data-wow-duration="1s"
              data-wow-delay="0.2s"
              data-img-url="/public/img/testimonials/1.jpg"
            ></div>
            <div
          ...
          <div class="right_details">
            <div
              class="det_image one wow fadeIn"
              data-wow-duration="1s"
              data-img-url="/public/img/testimonials/5.jpg"
            ></div>
            <div
              class="det_image two wow fadeIn"
              data-wow-duration="1s"
            ...
            <div
              ...
              data-wow-duration="1s"
              data-wow-delay="0.4s"
              data-img-url="/public/img/testimonials/7.jpg"
            ></div>
            <span class="circle yellow animPulse"></span>
      ...
      <div class="brush_1 wow fadeInRight" data-wow-duration="1s">
        <img src="/public/img/brushes/testimonials/1.png" alt="" />
      </div>
    </div>
  </div>
</template>
