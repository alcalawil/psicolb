  ...
  <div class="dizme_tm_section" id="blog">
    <div class="dizme_tm_news">
          ...
          <ul>
            <li class="wow fadeInUp" data-wow-duration="1s">
              <div class="list_inner">
                <div class="image">
                  <img src="/public/img/thumbs/42-29.jpg" alt="" />
                  <div class="main" data-img-url="/public/img/news/1.jpg"></div>
                  <div class="date">
                    <h3>23</h3>
                    <span>Dec</span>
                  </div>
            ...
            >
              <div class="list_inner">
                <div class="image">
                  <img src="/public/img/thumbs/42-29.jpg" alt="" />
                  <div class="main" data-img-url="/public/img/news/2.jpg"></div>
                  <div class="date">
                    <h3>23</h3>
                    <span>Dec</span>
                  </div>
            ...
            >
              <div class="list_inner">
                <div class="image">
                  <img src="/public/img/thumbs/42-29.jpg" alt="" />
                  <div class="main" data-img-url="/public/img/news/3.jpg"></div>
                  <div class="date">
                    <h3>23</h3>
                    <span>Dec</span>
                  </div>
      ...
      <div class="brush_1 wow zoomIn" data-wow-duration="1s">
        <img src="/public/img/brushes/news/1.png" alt="" />
      </div>
      <div class="brush_2 wow zoomIn" data-wow-duration="1s">
        <img src="/public/img/brushes/news/2.png" alt="" />
      </div>
    </div>
  </div>
